...
namespace AsyncInnReWrite.Controllers.Web
{
    public class HotelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address,City,State,Country,PhoneNum")] Hotels hotels)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,City,State,Country,PhoneNum")] Hotels hotels)
        {
            if (id != hotels.Id)
            {
                return NotFound();
