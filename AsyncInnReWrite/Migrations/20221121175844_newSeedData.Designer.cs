...
namespace AsyncInnReWrite.Migrations
{
    ...
    [Migration("20221121175844_newSeedData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AmenityRoomAmenities", b =>
                {
                    ...
                    b.Property<int>("Room Amenities")
                        .HasColumnType("int");

                    b.HasKey("Amenity", "Room Amenities");

                    b.HasIndex("Room Amenities");

                    b.ToTable("AmenityRoomAmenities");
                });
            ...
            modelBuilder.Entity("AmenityRoomAmenities", b =>
                {
                    b.HasOne("AsyncInnReWrite.Models.RoomAmenities", null)
                        .WithMany()
                        .HasForeignKey("Amenity")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AsyncInnReWrite.Models.Amenity", null)
                        .WithMany()
                        .HasForeignKey("Room Amenities")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
